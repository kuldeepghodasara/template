package com.peoplethink.governmentjob.providers.soundcloud.player.media;
...
import com.peoplethink.governmentjob.providers.soundcloud.player.remote.RemoteControlClientCompat;
import com.peoplethink.governmentjob.providers.soundcloud.player.remote.RemoteControlHelper;
...
public class MediaSessionWrapper {
     ...
     */
    static final String ACTION_TOGGLE_PLAYBACK = "com.peoplethink.governmentjob.providers.soundcloud.library.media.TOGGLE_PLAYBACK";
     ...
     * Action used to catch broadcast from {@link MediaSessionReceiver}
     */
    static final String ACTION_PREVIOUS_TRACK = "com.peoplethink.governmentjob.providers.soundcloud.library.media.PREVIOUS_TRACK";
